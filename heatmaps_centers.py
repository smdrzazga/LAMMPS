...
locations = ["G:/lammps dane/2z2x/nvt/d_0.32/all_snapshots_1.01.lammpstrj"]
...
def main():
    for location in locations:
        ...
        screen_file = "C:/Users/" + os.getlogin() + "/Desktop/LAMMPS_matrices/centers_matrices/centers_" + ("wall" if AT_WALL else "bulk") + "_" + mode + '_' + density + ".txt"
        # screen_file = "C:/Users/" + os.getlogin() + "/Desktop/LAMMPS_matrices/centers_matrices/centers_screen_bulk_two_domains_1.01.txt"
